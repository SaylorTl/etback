<template>
    ...
    <el-select v-model="value2" filterable clearable @clear="clear" @change="change" :size="size" :placeholder="placeholder">
    ...
    export default {
            ...
            this.getStation('','keyword').then(function(data){
                if(typeof(data) != 'undefined'){
                    vm.options = data.map(function(k){
                        return {value:k.id,label:k.coupon_type};
                    });
                    if(vm.value){
                        vm.value2 = vm.value;
                    }else{
        ...
        methods:{
            ...
            getStation:function(key,type){
                 var url = "";
                if(type == 'id'){
                    url = '/coupon/couType_show?id='+key;
                }else if(type == 'keyword'){
                    url = '/coupon/couType_lists?coupon_type='+key+'&page=1&pagesize=1000';
               }
